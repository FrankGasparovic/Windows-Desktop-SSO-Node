 ...
 * @since AM 5.5.0
 */
public class WindowsDesktopSSONodePlugin extends AbstractNodeAmPlugin {
	...
	protected Map<String, Iterable<? extends Class<? extends Node>>> getNodesByVersion() {
		return Collections.singletonMap(WindowsDesktopSSONodePlugin.currentVersion,
                                        Collections.singletonList(WindowsDesktopSSONode.class));
	}
	...
	public String getPluginVersion() {
		return WindowsDesktopSSONodePlugin.currentVersion;
	}
}
